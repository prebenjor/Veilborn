...
export const INFLUENCE_REGEN_PER_SHRINE_PER_SECOND = 0.16;
...
export const WHISPER_COST_SCALAR = 1.48;
...
export const ACOLYTE_ORDER_DURATION_MS = 40 * 1000;
export const ACOLYTE_ORDER_REPEAT_STEP = 0.18;
export const ACOLYTE_ORDER_REPEAT_MAX_PENALTY = 0.6;
export const ACOLYTE_ORDER_GATHER_IMMEDIATE_BASE = 3;
export const ACOLYTE_ORDER_GATHER_IMMEDIATE_PER_ACOLYTE = 1.5;
export const ACOLYTE_ORDER_GATHER_PASSIVE_PER_ACOLYTE = 0.035;
export const ACOLYTE_ORDER_LISTEN_RECRUIT_MULTIPLIER = 0.2;
export const ACOLYTE_ORDER_LISTEN_WHISPER_BELIEF_MULTIPLIER = 0.25;
export const ACOLYTE_ORDER_STEADY_INFLUENCE_PER_ACOLYTE = 0.08;
export const ACOLYTE_ORDER_STEADY_INFLUENCE_CAP = 1.0;
...
export const ACOLYTE_THRESHOLD_SCALAR = 1.4;
